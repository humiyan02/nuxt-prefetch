...
var require_explode = __commonJS({
  "node_modules/.pnpm/babel-walk@3.0.0-canary-5/node_modules/babel-walk/lib/explode.js"(exports) {
    ...
    var t4 = __importStar(__require("@babel/types"));
...
function transformScriptSetup(sfc, options) {
  ...
  if (body.length) {
    hasBody = true;
    const returnExpr = expose ? t2.callExpression(t2.memberExpression(t2.identifier("Object"), t2.identifier("assign")), [t2.objectExpression(returns), expose]) : t2.objectExpression(returns);
    const returnStatement = t2.returnStatement(returnExpr);
